...
`BC_coast_animation.py` generates a map of Vancouver Island and the BC coast, visualizing both topography and bathymetry using high-resolution GEBCO data. The script uses Cartopy and Matplotlib to plot the region with a custom terrain colormap.
